// FROZEN CONTROL — src/model/pitcher.js exactly as it stood at v36.1 (master
// 3914d97), before docs/PITCHER-PORT.md changed it.
//
// It exists for one reason. The study this port carries out
// (docs/PITCHER-EDGE-SEARCH.md) measured its candidate against
// `src/model/pitcher.js` itself, so the moment the port lands, any comparison
// against that import is the new model measured against itself. Every number
// in docs/PITCHER-PORT.md is paired against THIS file.
//
// Nothing here may be edited. If the shipped model changes, this file does not.
// Copy made with:
//   sed -e "s#'../lib/#'../src/lib/#" -e "s#'./league.js'#'../src/model/league.js'#" \
//       src/model/pitcher.js > tools/pitcher-model-v1.mjs
/**
...
export { projectPitcher as projectPitcherV1 };
