...
import {
  kget, readJson, settledMarkets as settledMarketsIn, quoteAt, summarize as summarizeBoot, scoring,
  brierDiff as brierDiffBoot, calibrationBins, brierOptimalModelWeight, priceBucket, KALSHI,
...
const settledMarkets = (series) => settledMarketsIn(KCACHE, series);
...
async function main() {
  ...
  const skill = (list) => ({
    ...
    // Diagnostic, not a tuning (see kalshi-common.mjs).
